			...
			<div class="modal-content modal-info">
				...
				<div class="modal-body modal-spa">
					<div class="login-form">			
						...
						<ol>
							<li>
								<input type="text" id="code" name="empCode" placeholder="编号" title="Code" required />
							</li>
							<li>
								<input type="text" id="account" name="empAccount" placeholder="账号" title="Account" required />
							</li>
							<li>
								<input type="text" id="name" name="empName" placeholder="姓名" title="Name" required />
							</li>
							<li>
								<span style="color: white">性别：</span><input type="radio" id="empSex" name="empSex" value="男" placeholder="性别" title="Sex" checked="checked" required /><span style="color:white;margin-right: 10px">男</span>
								<input type="radio" id="empSex" name="empSex" value="女" placeholder="性别" title="Sex" required /><span style="color:white;margin-right: 10px">女</span>
							</li>
							<li>
								<input type="text" id="empLiveAddress" name="empLiveAddress" placeholder="居住地" title="empLiveAddress" required />
							</li>
							<li>
								<input type="text" id="empWorkAddress" name="empWorkAddress" placeholder="工作地" title="empLiveAddress" required />
							</li>
							<li>
								<input type="email" id="email" name="empEmail" placeholder="Mail@example.com" title="Please enter a valid email" required />
							...
							<li>
								<input type="tel" id="tel" name="empPhone" pattern="\d{11}" placeholder="Please enter a phone number" required />
								<p class="validation01">
							...
							<li>
								<input type="password" class="lock" name="empPassword" title="Minimum 8 characters, one number, one uppercase and one lowercase letter" pattern="(?=^.{6,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*" placeholder="Password" id="password1" required />
								<p class="validation01">
